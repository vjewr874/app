...
! function () {
    ...
    t.jqPaginator = function (e, a) {
        ...
        return r.$container = t(e), r.$container.data("jqPaginator", r), r.init = function () {
            ...
            var t = r.options;
            t.totalCounts = t.totalCounts < 1 ? 1 : t.totalCounts;
            t.currentPage = t.currentPage < 1 ? 1 : t.currentPage;
            ...
            if(t.currentPage > t.totalPages) t.currentPage = t.totalPages;
            // if ( && (t.totalPages = Math.ceil(t.totalCounts / t.pageSize)), t.currentPage < 1 || t.currentPage > t.totalPages) throw new Error("[jqPaginator] currentPage is incorrect");
